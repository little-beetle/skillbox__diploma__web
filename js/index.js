...
btnPlaylist.forEach(function (el) {
  el.addEventListener("click", function (e) {
    e.target.closest(".playlist__item__wrapper").classList.toggle("playlist__item__wrapper--toggle");
  });
});
...
function getElements__1(type) {
	return [].slice.call(document.querySelectorAll('.' + type)).sort(function (targetNode1__1, targetNode2__1) {
...
function getElements__2(type) {
	return [].slice.call(document.querySelectorAll('.' + type)).sort(function (targetNode1__2, targetNode2__2) {
...
function podcastPlay__1() {
  return podcast__audio__1.paused ? podcast__audio__1.play() : podcast__audio__1.pause();
};

function podcastPlay__2() {
  return podcast__audio__2.paused ? podcast__audio__2.play() : podcast__audio__2.pause();
};

function podcastPlay__3() {
  return podcast__audio__3.paused ? podcast__audio__3.play() : podcast__audio__3.pause();
};

function podcastPlay__4() {
  return podcast__audio__4.paused ? podcast__audio__4.play() : podcast__audio__4.pause();
};

function podcastPlay__5() {
  return podcast__audio__5.paused ? podcast__audio__5.play() : podcast__audio__5.pause();
};

function podcastPlay__6() {
  return podcast__audio__6.paused ? podcast__audio__6.play() : podcast__audio__6.pause();
};

function podcastPlay__7() {
  return podcast__audio__7.paused ? podcast__audio__7.play() : podcast__audio__7.pause();
};

function podcastPlay__8() {
  return podcast__audio__8.paused ? podcast__audio__8.play() : podcast__audio__8.pause();
};

function podcastPlay__9() {
  return podcast__audio__9.paused ? podcast__audio__9.play() : podcast__audio__9.pause();
};

function podcastPlay__10() {
  return podcast__audio__10.paused ? podcast__audio__10.play() : podcast__audio__10.pause();
};
